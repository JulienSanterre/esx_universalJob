Locales['fr'] = {   
  ...
  ['invalid_action_car']        = 'Action ~r~impossible~s~, cette personne est en voiture',
  ['early_call']        		= 'Vous avez déjà traité avec ce client',
  ['deal_refuse']        		= 'Le client a refusé vos cigarettes !',
  ['deal_accept']        		= 'Le client a accepté vos cigarettes !',
  ['deal_accept_hight']        	= 'Le client a accepté vos cigarettes plus chère!',
  ['deal_accept_veryhight']     = 'Le client s\'est ruiné pour prendre vos cigarettes!',
  ['no_product_sell']     		= 'Vous n\'avez pas vos cigarettes sur vous',
  ['nobody_close']     			= 'Vous n\'avez pas vos cigarettes sur vous',
  ['smoke_drive']     			= 'Si vous fumez attention au volant ...',
  ['sechage_fermentation']     	= 'Séchage et Fermentation en cours...',
  ['end_stock']     			= 'Vous n\'avez pas les cigarettes demandées ',
  ['smoke_marlboro']     		= 'Vous avez fumé ~g~1 ~w~x ~g~Malboro',
  ['smoke_chinease']     		= 'Vous avez fumé ~g~1 ~w~x ~g~Cigarette chinoise',
  ['smoke_gitanos']     		= 'Vous avez fumé ~g~1 ~w~x ~g~Gitane',
  ['smoke_weed']     			= 'Vous fumez ~g~1 ~w~x ~g~splif de weed',
  ['try_glitch']     			= '~r~C\'est pas bien de glitch ~w~',
  ['out_zone']     				= 'Vous sortez de la ~r~zone',
  ['sell_zone']     			= 'Vous pouvez ~g~vendre',
  ['max_vehicle']     			= 'Ca suffit tu en a assez, va chercher l\'autre',
  ['not_inof']     				= 'Vous n\'en avez pas assez pour faire cela !',
  ['store_vip']     			= 'Vous ne pouvez pas stocker les objets VIP ou contributeur',
